...
// Briófitas
        ...
        // =========================
// PLANTAS NATIVAS DO CEARÁ – COMPLEMENTO MAIS AMPLIADO
// =========================

// Caatinga – árvores e arbustos comuns
...
// Fruteiras e plantas com frutos típicos
        plantas.add(new Especie("Umbuzeiro", "Caatinga", ClassificacaoBotanica.ANGIOSPERMA_DICOTILEDONEA));
...
// Cactáceas adicionais (adaptadas ao semiárido)
...
// Plantas medicinais ou usadas tradicionalmente
        ...
        // --- ESPÉCIES NATIVAS REAIS DO CEARÁ – GRANDE COMPLEMENTO ---
...
// Cactáceas registradas no Ceará
...
// Árvores e arbustos extras comuns
...
// Medicinais e etnobotânicas que ocorrem no semiárido
...
// =========================
// AMPLIAÇÃO REALISTA DO CATÁLOGO – CAATINGA/CEARÁ
// =========================

// Macambira (Bromélia típica do semiárido)
        plantas.add(new Especie("Macambira", "Caatinga", ClassificacaoBotanica.ANGIOSPERMA_MONOCOTILEDONEA));

// Espécies arbustivas e herbáceas nativas
...
// Árvores e arbustos adicionais que ocorrem no bioma
...
// Cactáceas adicionais da Caatinga
...
// Plantas herbáceas e forrageiras
...
// Trepadeiras nativas ou associadas ao bioma
...
// Espécies de Euphorbiaceae adaptadas
